#
# Be sure to run `pod lib lint SlackWebAPIKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SlackWebAPIKit.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'SlackWebAPIKit' => ['SlackWebAPIKit/Assets/*.png']
  # }
